...
> Repository development instructions for **bom** (Shared Package).
> Stack: java-maven. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Central dependency management (Bill of Materials) for the Omnixys Java ecosystem.

- Repository path: `packages/java/bom` (relative to the Omnixys root)
...
BOM changes affect every consuming service/package; SemVer discipline required.
